...
import { Mail, Lock, Eye, EyeOff, FileText, Play, User } from 'lucide-react';
        ...
        <div className="glass-card p-8">
          ...
          <div className="space-y-4 mb-6">
            ...
            <button
              type="button"
              onClick={handleGuest}
              className="btn-secondary w-full !bg-surface-800 hover:!bg-surface-700 text-surface-300"
            >
            ...
            <button
              ...
              className="btn-secondary w-full !bg-blue-500/10 hover:!bg-blue-500/20 text-blue-400 border-blue-500/20"
            >
