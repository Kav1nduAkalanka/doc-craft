    ...
    >
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="glass-card p-8">
          ...
          <p className="text-sm text-surface-400 text-center mb-6">Start creating professional documents for free</p>

          {/* Google OAuth */}
          <button onClick={googleAuth} className="btn-google mb-4" id="register-google">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {displayError && (
              <div className="p-3 bg-red-500/10 border border-red-500/30 rounded-xl text-sm text-red-300" id="register-error">
                {displayError}
              </div>
            )}
            ...
            <button type="submit" disabled={isLoading} className="btn-primary w-full" id="register-submit">
